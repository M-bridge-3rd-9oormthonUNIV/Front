...
import { Modal,AlertModal } from "../shared/modal.jsx";
...
export default function ImageGeneratePage({
  ...
  useEffect(() => {
    ...
    setImageUrl(
      "https://i.postimg.cc/ZRpD2rGY/DALL-E-2024-10-11-08-36-24-A-dreamy-surreal-landscape-that-captures-the-essence-of-a-summer-night.webp"
    );
  ...
  return (
    <>
      ...
      >
        ...
        <div className="gallery">
          <img
            ...
            src={imageUrl}
            style={{
              opacity: `${leftSubPageVisible ? "1" : "0"}`,
              cursor: "pointer",
            }}
            alt="생성된 이미지"
      ...
      <motion.div
        ...
        transition={{ type: "spring", stiffness: 30 }} // 스프링 애니메이션 설정
      >
        <SubLyricsDisplay songId={songId} direction={"left"} />
      </motion.div>
