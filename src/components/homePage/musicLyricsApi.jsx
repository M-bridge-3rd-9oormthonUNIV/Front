    ...
    return (
        <div>
          <p>
            ...
            날 서서히 죽여와<br />
            창문 밖을 보며<br />
            그 밑에 네가 항상 기다려주길 바라<br />
            악마는 주사위를 굴리고, 천사들은 눈을 굴리지<br />
            날 죽이지 않는 것이 널 더 원하게 만들어<br />
            새로워<br />
            네 몸의 형상이<br />
            우울해<br />
            내가 느끼는 기분은<br />
            ...
            그 아래로 고개를 숙이는 너<br />
            난 죽지 못해<br />
            힘든 시간엔 모든 걸 망칠 거라고<br />
            우린 그렇게 말했지<br />
            시도조차 하지 않았는걸<br />
            그러니 헤드라이트를 꺼<br />
            여름은 칼과도 같아<br />
            언제나 그 칼로 날 열어주길 기다리지<br />
            악마는 주사위를 굴리고, 천사들은 눈을 굴려<br />
            피 흘리는 나를, 넌 가장 마지막에 알게 될 거야<br />
            새로워<br />
            네 몸의 형상이<br />
            우울해<br />
            내가 느끼는 기분은<br />
            ...
            잔인한 여름이야<br />
            너와 함께한<br />
            난 술에 취한 채 자동차 뒷좌석에 앉았고<br />
            바에서 집으로 오는 내내 아이처럼 울었어<br />
            괜찮다고 했지만, 사실 아니었어<br />
            더 이상 비밀로 하고 싶지 않아<br />
            널 지킨다는 이유로<br />
            그 여름, 매일 밤 정원의 문으로 몰래 들어갔지<br />
            그저 내 운명을 정하기 위해서<br />
            그리고 난 소리쳐,<br />
            이게 무슨 의미가 있겠어,<br />
            그런데도 널 사랑해,<br />
            네가 들어본 말들 중 최악이지 않아?<br />
            그는 악마처럼 웃으며 날 바라봐<br />
            새로워<br />
            네 몸의 형상이<br />
            우울해<br />
            내가 느끼는 기분은<br />
