...
export default function LogoWithAnimation() {
    ...
    return (
      <div className="logo-container">
        {!isLogoClicked && (
        <div
          className={`logo ${isLogoClicked ? "logo-clicked" : ""}`}
          onClick={handleLogoClick}
        />
      )}
        {isLogoClicked && (
          <div className="service-description">
            <p className="service-text">‘엠브릿지(M-bridge)’는 전 세계 음악 팬들을 위한 혁신적인 가사 번역 서비스입니다. 언어의 장벽을 허물고, 다양한 문화권의 음악을 이해하고 즐길 수 있도록 돕기 위해 만들어졌습니다.</p>
